...
async function connectDB() {
    try {
        ...
        for (let i = 0; i < databaseNames.length; i++) {
            const DBconnectionString = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0.q0px1.mongodb.net/${databaseNames[i]}?retryWrites=true&w=majority`;
